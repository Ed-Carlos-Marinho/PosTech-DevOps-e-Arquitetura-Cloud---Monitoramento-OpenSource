...
echo "1. Clonar repositório: git clone -b aula-03 https://github.com/Ed-Carlos-Marinho/PosTech-DevOps-e-Arquitetura-Cloud---Monitoramento-OpenSource.git"
...
echo "   - Zabbix: http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):8081 (Admin/zabbix)"
echo ""
